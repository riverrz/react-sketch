...
class SketchFieldDemo extends React.Component {
  ...
  render = () => {
    let canavs = this._sketch && this._sketch.getCanavsRef()
    let ctx = canavs && canavs.getContext("2d")
    if(ctx) {
        ...
        <div className="row">
          <div className="col-xs-7 col-sm-7 col-md-9 col-lg-9">
            <SketchField
              ...
              onMouseMove={(e) => {
                    // this.mouseX = e.e.pageX - this.offsetLeft;
                    // this.mouseX = e.e.pageX - this.offsetLeft;
                    this.mouseX = e.e.pageX;
                    this.mouseX = e.e.pageX;
                    // if (highlight) {
                      if(ctx)
                      ctx.fillRect(this.mouseX, this.mouseY, 20, 20);
                    // }
                    // console.log("mouse move-himanshu")
              }}
              fillColor={
